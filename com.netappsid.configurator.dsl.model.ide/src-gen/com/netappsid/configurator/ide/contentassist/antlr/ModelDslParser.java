 ...
 */
package com.netappsid.configurator.ide.contentassist.antlr;

import com.google.inject.Inject;
import com.netappsid.configurator.ide.contentassist.antlr.internal.InternalModelDslParser;
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDefaultValueAccess().getAlternatives_2(), "rule__DefaultValue__Alternatives_2");
					put(grammarAccess.getDynamicEnumColumnAccess().getAlternatives_7(), "rule__DynamicEnumColumn__Alternatives_7");
					...
					put(grammarAccess.getConfigurableAccess().getGroup(), "rule__Configurable__Group__0");
					put(grammarAccess.getConfigurableAccess().getGroup_3(), "rule__Configurable__Group_3__0");
					...
					put(grammarAccess.getEnumMemberAccess().getGroup_1_1(), "rule__EnumMember__Group_1_1__0");
					put(grammarAccess.getEnumFieldValueAccess().getGroup(), "rule__EnumFieldValue__Group__0");
					put(grammarAccess.getDynamicEnumAccess().getGroup(), "rule__DynamicEnum__Group__0");
					put(grammarAccess.getDynamicEnumAccess().getGroup_6(), "rule__DynamicEnum__Group_6__0");
					put(grammarAccess.getDynamicEnumColumnAccess().getGroup(), "rule__DynamicEnumColumn__Group__0");
					...
					put(grammarAccess.getConfigurableAccess().getAbstractAssignment_0(), "rule__Configurable__AbstractAssignment_0");
					put(grammarAccess.getConfigurableAccess().getNameAssignment_2(), "rule__Configurable__NameAssignment_2");
					put(grammarAccess.getConfigurableAccess().getSuperTypeAssignment_3_1(), "rule__Configurable__SuperTypeAssignment_3_1");
					put(grammarAccess.getConfigurableAccess().getPropertiesAssignment_5(), "rule__Configurable__PropertiesAssignment_5");
					...
					put(grammarAccess.getPropertyAccess().getDefaultValueAssignment_2_0(), "rule__Property__DefaultValueAssignment_2_0");
					put(grammarAccess.getPropertyAccess().getAttributesAssignment_2_1_1(), "rule__Property__AttributesAssignment_2_1_1");
					put(grammarAccess.getDefaultValueAccess().getDefaultValueAssignment_1(), "rule__DefaultValue__DefaultValueAssignment_1");
					put(grammarAccess.getDefaultValueAccess().getUnitAssignment_2_0(), "rule__DefaultValue__UnitAssignment_2_0");
					put(grammarAccess.getDefaultValueAccess().getUnitAssignment_2_1(), "rule__DefaultValue__UnitAssignment_2_1");
					put(grammarAccess.getAttributeAccess().getNameAssignment_0(), "rule__Attribute__NameAssignment_0");
					put(grammarAccess.getAttributeAccess().getExpressionAssignment_2(), "rule__Attribute__ExpressionAssignment_2");
					put(grammarAccess.getEnumAccess().getNameAssignment_1(), "rule__Enum__NameAssignment_1");
					put(grammarAccess.getEnumAccess().getFieldsAssignment_3(), "rule__Enum__FieldsAssignment_3");
					put(grammarAccess.getEnumAccess().getMembersAssignment_4(), "rule__Enum__MembersAssignment_4");
					put(grammarAccess.getEnumFieldAccess().getTypeAssignment_1(), "rule__EnumField__TypeAssignment_1");
					put(grammarAccess.getEnumFieldAccess().getNameAssignment_2(), "rule__EnumField__NameAssignment_2");
					put(grammarAccess.getEnumMemberAccess().getNameAssignment_0(), "rule__EnumMember__NameAssignment_0");
					put(grammarAccess.getEnumMemberAccess().getImagePathAssignment_1_1_1(), "rule__EnumMember__ImagePathAssignment_1_1_1");
					put(grammarAccess.getEnumMemberAccess().getValuesAssignment_1_2(), "rule__EnumMember__ValuesAssignment_1_2");
					put(grammarAccess.getEnumFieldValueAccess().getNameAssignment_0(), "rule__EnumFieldValue__NameAssignment_0");
					put(grammarAccess.getEnumFieldValueAccess().getValueAssignment_2(), "rule__EnumFieldValue__ValueAssignment_2");
					put(grammarAccess.getDynamicEnumAccess().getNameAssignment_1(), "rule__DynamicEnum__NameAssignment_1");
					put(grammarAccess.getDynamicEnumAccess().getTableNameAssignment_4(), "rule__DynamicEnum__TableNameAssignment_4");
					put(grammarAccess.getDynamicEnumAccess().getColumnsAssignment_5(), "rule__DynamicEnum__ColumnsAssignment_5");
					put(grammarAccess.getDynamicEnumAccess().getImageColumnAssignment_6_1(), "rule__DynamicEnum__ImageColumnAssignment_6_1");
					put(grammarAccess.getDynamicEnumColumnAccess().getNameAssignment_1(), "rule__DynamicEnumColumn__NameAssignment_1");
					put(grammarAccess.getDynamicEnumColumnAccess().getColumnIndexAssignment_4(), "rule__DynamicEnumColumn__ColumnIndexAssignment_4");
					put(grammarAccess.getDynamicEnumColumnAccess().getLabelAssignment_6(), "rule__DynamicEnumColumn__LabelAssignment_6");
