...
@after {
	...
	(
		...
		{
			$current = $this_Configurable_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_DynamicEnum_3.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleConfigurable returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getConfigurableRule()); }
	iv_ruleConfigurable=ruleConfigurable
	{ $current=$iv_ruleConfigurable.current; }
	EOF;

// Rule Configurable
ruleConfigurable returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleEnumFieldValue returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEnumFieldValueRule()); }
	iv_ruleEnumFieldValue=ruleEnumFieldValue
	{ $current=$iv_ruleEnumFieldValue.current; }
	EOF;

// Rule EnumFieldValue
ruleEnumFieldValue returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDynamicEnum returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDynamicEnumRule()); }
	iv_ruleDynamicEnum=ruleDynamicEnum
	{ $current=$iv_ruleDynamicEnum.current; }
	EOF;

// Rule DynamicEnum
ruleDynamicEnum returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDynamicEnumColumn returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDynamicEnumColumnRule()); }
	iv_ruleDynamicEnumColumn=ruleDynamicEnumColumn
	{ $current=$iv_ruleDynamicEnumColumn.current; }
	EOF;

// Rule DynamicEnumColumn
ruleDynamicEnumColumn returns [EObject current=null]
@init {
	enterRule();
}
@after {
